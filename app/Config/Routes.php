...
$routes->match(['get', 'post'], 'listaEmpresas', 'ListaEmpresas::index');
$routes->match(['get', 'post'], 'listaMarcajes', 'ListaMarcajes::index');
$routes->match(['get', 'post'], 'listaTrabajadores', 'ListaTrabajadores::index');
